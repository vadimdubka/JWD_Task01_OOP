...
public class Main {
	...
	public static void main(String[] args) {
		...
		criteriaOven.setApplianceType("Oven"); // TODO строка добавлена на основании договоренности на консультации
		...
		criteriaTabletPC.setApplianceType("TabletPC"); // TODO строка добавлена на основании договоренности на консультации
